...
CREATE TABLE competition (
    cid integer PRIMARY KEY, --Competition ID
...
--This will have a single row containing the key of the default competition

CREATE TABLE default_competition (
    cid integer REFERENCES competition(cid) ON UPDATE CASCADE ON DELETE SET NULL, --Competition ID
    version character varying --Version no of of the database definition
);
...
CREATE TABLE participant (
    ...
    is_bb boolean DEFAULT false NOT NULL --user is a baby backup
);
...
CREATE TABLE pick (
    ...
    submit_time bigint DEFAULT (strftime('%s','now')) NOT NULL, --Time of submission
    PRIMARY KEY (uid,cid,rid,hid)
);

-- Record of users registerd with a competition
CREATE TABLE registration (
    uid integer NOT NULL REFERENCES participant(uid) ON UPDATE CASCADE ON DELETE CASCADE, --User ID
    cid integer NOT NULL REFERENCES competition(cid) ON UPDATE CASCADE ON DELETE CASCADE, --Competition ID
    agree_time bigint DEFAULT (strftime('%s','now')) NOT NULL , --Time Agreed to Competition Conditions
    bb_approved boolean DEFAULT false NOT NULL, --Set if BB has been approved to play
    PRIMARY KEY(uid,cid)
);
...
CREATE TABLE team_in_competition (
    cid integer NOT NULL REFERENCES competition(cid) ON UPDATE CASCADE ON DELETE CASCADE, --Competition ID
    tid character(3) NOT NULL REFERENCES team(tid) ON UPDATE CASCADE ON DELETE CASCADE, --Team ID
...
CREATE TABLE wildcard_pick (
    ...
    submit_time bigint DEFAULT (strftime('%s','now')) NOT NULL, --Time of Submission
    PRIMARY KEY(uid,cid,confid,opid)
);
...
CREATE VIEW playoff_score AS
	SELECT u.cid, u.uid, count(p.uid) AS score, p.confid
		FROM registration u
		LEFT JOIN (playoff_picks p JOIN team_in_competition t ON p.cid = t.cid AND p.tid = t.tid AND t.made_playoff = 1)
...
INSERT INTO default_competition (cid, version) VALUES (NULL,1);
...
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('NE','New England Patriots','NE_logo-50x50.gif','AFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('NYG','New York Giants','NYG_logo-50x50.gif','NFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('TEN','Tennessee Titans','TEN_logo-50x50.gif','AFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('IND','Indianapolis Colts','IND_logo-50x50.gif','AFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('DAL','Dallas Cowboys','DAL_logo-50x50.gif','NFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('WAS','Washington Redskins','WAS_logo-50x50.gif','NFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('SEA','Seattle Seahawks','SEA_logo-50x50.gif','NFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('ATL','Atlanta Falcons','ATL_logo-50x50.gif','NFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('CIN','Cincinnati Bengals','CIN_logo-50x50.gif','AFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('MIA','Miami Dolphins','MIA_logo-50x50.gif','AFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('CAR','Carolina Panthers','CAR_logo-50x50.gif','NFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('TB','Tampa Bay Buccaneers','TB_logo-50x50.gif','NFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('BUF','Buffalo Bills','BUF_logo-50x50.gif','AFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('PHI','Philadelphia Eagles','PHI_logo-50x50.gif','NFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('NO','New Orleans Saints','NO_logo-50x50.gif','NFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('CHI','Chicago','CHI_logo-50x50.gif','NFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('JAC','Jacksonville Jaguars','JAC_logo-50x50.gif','AFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('HOU','Houston Texans','HOU_logo-50x50.gif','AFC','S');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('SF','San Francisco 49ers','SF_logo-50x50.gif','NFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('CLE','Cleveland Browns','CLE_logo-50x50.gif','AFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('PIT','Pittsburgh Steelers','PIT_logo-50x50.gif','AFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('BAL','Baltimore Ravens','BAL_logo-50x50.gif','AFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('DET','Detroit Lions','DET_logo-50x50.gif','NFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('GB','Green Bay Packers','GB_logo-50x50.gif','NFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('SD','San Diego Chargers','SD_logo-50x50.gif','AFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('AK','Oakland Raiders','OAK_logo-50x50.gif','AFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('MIN','Minnesota Vikings','MIN_logo-50x50.gif','NFC','N');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('DEN','Denver Broncos','DEN_logo-50x50.gif','AFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('STL','St. Louis Rams','STL_logo-50x50.gif','NFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('NYJ','New York Jets','NYJ_logo-50x50.gif','AFC','E');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('ARI','Arizona Cardinals','ARI_logo-50x50.gif','NFC','W');
INSERT INTO team (tid, name, logo, url, confid, divid) VALUES('KC','Kansas City Chiefs','KC_logo-50x50.gif','AFC','W');

-- END OF DATA ----------------------------------------------------------
-- INDEXES --------------------------------------------------------------

CREATE INDEX div_cid_tid_idx ON div_winner_pick (cid,tid);
CREATE INDEX wild_cid_tid_idx ON wildcard_pick (cid,tid);
